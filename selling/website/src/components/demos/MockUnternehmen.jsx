        ...
        <div className="flex-1 w-full h-full overflow-y-auto bg-background p-8">
            <div className="space-y-6">
                <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h2 className="text-[24px] font-semibold tracking-tight text-foreground">Einstellungen</h2>
                        <p className="text-sm text-muted-foreground mt-1">Verwalten Sie Ihre Unternehmensdaten und App-Konfigurationen</p>
                    </div>
                </div>
